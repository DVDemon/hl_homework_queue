...
#include "handlers/WallHandler.h"
...
public:
        ...
        const HTTPServerRequest& request)
    {
        ...
        if (startsWith(request.getURI(),chat))  return new ChatHandler(_format);
        if (startsWith(request.getURI(),wall))  return new WallHandler(_format);
